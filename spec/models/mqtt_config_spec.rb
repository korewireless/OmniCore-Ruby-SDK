...
# Unit tests for OpenapiClient::MqttConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MqttConfig do
  let(:instance) { OpenapiClient::MqttConfig.new }

  describe 'test an instance of MqttConfig' do
    it 'should create an instance of MqttConfig' do
      expect(instance).to be_instance_of(OpenapiClient::MqttConfig)
    end
  end
