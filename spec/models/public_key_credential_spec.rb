...
# Unit tests for OpenapiClient::PublicKeyCredential
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PublicKeyCredential do
  let(:instance) { OpenapiClient::PublicKeyCredential.new }

  describe 'test an instance of PublicKeyCredential' do
    it 'should create an instance of PublicKeyCredential' do
      expect(instance).to be_instance_of(OpenapiClient::PublicKeyCredential)
    end
  end
