...
# Unit tests for OpenapiClient::PublicKeyCertificate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PublicKeyCertificate do
  let(:instance) { OpenapiClient::PublicKeyCertificate.new }

  describe 'test an instance of PublicKeyCertificate' do
    it 'should create an instance of PublicKeyCertificate' do
      expect(instance).to be_instance_of(OpenapiClient::PublicKeyCertificate)
    end
  end
