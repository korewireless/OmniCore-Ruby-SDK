...
# Unit tests for OpenapiClient::GatewayConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GatewayConfig do
  let(:instance) { OpenapiClient::GatewayConfig.new }

  describe 'test an instance of GatewayConfig' do
    it 'should create an instance of GatewayConfig' do
      expect(instance).to be_instance_of(OpenapiClient::GatewayConfig)
    end
  end
