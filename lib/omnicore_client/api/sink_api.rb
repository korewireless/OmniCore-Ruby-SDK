...
module OmniCoreClient
  class SinkApi
    ...
    def create_sink_with_http_info(subscription_id, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionId}/sinks'.sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s))
    ...
    def delete_sink_with_http_info(subscription_id, sink_id, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionId}/sinks/{sinkId}'.sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s)).sub('{' + 'sinkId' + '}', CGI.escape(sink_id.to_s))
