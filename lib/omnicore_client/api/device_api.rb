...
module OmnicoreClient
  class DeviceApi
    ...
    def bind_device_with_http_info(subscription_id, registry_id, bind, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionId}/registries/{registryId}/bindDeviceToGateway'.sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s))
    ...
    def bind_devices_with_http_info(subscription_id, registry_id, bind, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionId}/registries/{registryId}/bindDevicesToGateway'.sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s))
    ...
    def block_device_communcation_with_http_info(subscriptionid, registry_id, device_id, block, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/communication'.sub('{' + 'subscriptionid' + '}', CGI.escape(subscriptionid.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s)).sub('{' + 'deviceId' + '}', CGI.escape(device_id.to_s))
    ...
    def create_device_with_http_info(subscription_id, registry_id, device, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionId}/registries/{registryId}/devices'.sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s))
    ...
    def delete_device_with_http_info(subscription_id, registry_id, device_id, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionId}/registries/{registryId}/devices/{deviceId}'.sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s)).sub('{' + 'deviceId' + '}', CGI.escape(device_id.to_s))
    ...
    def get_config_with_http_info(subscriptionid, registry_id, device_id, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/configVersions'.sub('{' + 'subscriptionid' + '}', CGI.escape(subscriptionid.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s)).sub('{' + 'deviceId' + '}', CGI.escape(device_id.to_s))
    ...
    def get_states_with_http_info(subscriptionid, registry_id, device_id, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/states'.sub('{' + 'subscriptionid' + '}', CGI.escape(subscriptionid.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s)).sub('{' + 'deviceId' + '}', CGI.escape(device_id.to_s))
    ...
    def send_command_to_device_with_http_info(subscriptionid, registry_id, device_id, command, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/sendCommandToDevice'.sub('{' + 'subscriptionid' + '}', CGI.escape(subscriptionid.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s)).sub('{' + 'deviceId' + '}', CGI.escape(device_id.to_s))
    ...
    def un_bind_device_with_http_info(subscription_id, registry_id, unbind, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionId}/registries/{registryId}/unbindDeviceFromGateway'.sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s))
    ...
    def un_bind_devices_with_http_info(subscription_id, registry_id, unbind, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionId}/registries/{registryId}/unbindDevicesFromGateway'.sub('{' + 'subscriptionId' + '}', CGI.escape(subscription_id.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s))
    ...
    def update_configuration_to_device_with_http_info(subscriptionid, registry_id, device_id, configuration, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/updateConfigurationToDevice'.sub('{' + 'subscriptionid' + '}', CGI.escape(subscriptionid.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s)).sub('{' + 'deviceId' + '}', CGI.escape(device_id.to_s))
    ...
    def update_custom_onboard_request_with_http_info(subscriptionid, registry_id, device_id, custom_onboard, opts = {})
      ...
      # resource path
      local_var_path = '/subscriptions/{subscriptionid}/registries/{registryId}/devices/{deviceId}/updateCustomOnboardRequest'.sub('{' + 'subscriptionid' + '}', CGI.escape(subscriptionid.to_s)).sub('{' + 'registryId' + '}', CGI.escape(registry_id.to_s)).sub('{' + 'deviceId' + '}', CGI.escape(device_id.to_s))
