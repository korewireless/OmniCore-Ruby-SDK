  ...
  class EventNotificationConfig
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OmniCoreClient::EventNotificationConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OmniCoreClient::EventNotificationConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'pubsub_topic_name')
        self.pubsub_topic_name = attributes[:'pubsub_topic_name']
      end

      if attributes.key?(:'subfolder_matches')
        self.subfolder_matches = attributes[:'subfolder_matches']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          pubsub_topic_name == o.pubsub_topic_name &&
          subfolder_matches == o.subfolder_matches
    end
    ...
    def hash
      [pubsub_topic_name, subfolder_matches].hash
    end
